...
> Annotation: If the branch-masters sass does not work correctly - some package is missing. Everything works on branch test
...
I highly recommend also to look into the [playground folder](./src/playground/) - it shows which things I had to practice to understand the implementation thoroughly. There is a version of the application written in JSX. To do those exercises I was using mainly [React Documentation](https://reactjs.org/docs/getting-started.html).
